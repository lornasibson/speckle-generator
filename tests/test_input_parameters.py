...
@pytest.mark.parametrize('size_x, output',
...
@pytest.mark.parametrize('prop_goal, output',
...
@pytest.mark.parametrize('white_bg, output',
...
@pytest.mark.parametrize('image_res, output',
